...
// Wrap functins in mod to be used as "LogicEditingArticle::creat()" outside.
pub async fn create(new_editing_article: NewEditingArticle, c: &PgConnection) -> Result<EditingArticle, Error> {
