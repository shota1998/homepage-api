...
# MY_AWS_RDS_PORT          : Port which your DB is opening.
# MY_AWS_RDS_DATABASE_NAME : DB name which you named when you created DB.
# MY_AWS_IAM_USER          : IAM user name which you use when execute this script.

# TOKEN="$(aws rds generate-db-auth-token \
#                      --hostname $MY_AWS_RDS_HOST \
#                      --port $MY_AWS_RDS_PORT \
...
#     sslmode     = verify-full
#     dbname      = $MY_AWS_RDS_DATABASE_NAME
